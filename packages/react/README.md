...
const chainId = '8002'; // Amoy chainId
const chainNamespace = 'eip155'; // EVM compatible chains
const options = { tenant: "davinci", deployment: "development" }

return (
  <MediaSdkClientProvider signer={signer} chainId={selectedChainId} chainNamespace={selectedChainNamespace} options={options}>
    // your application
